...
check_symbol_exists(MODULE_VERSION "${CMAKE_SOURCE_DIR}/include/modules/version.h" SUBMODULE_ENABLED)

if(SUBMODULE_ENABLED)
    cmake_push_check_state()
    set(CMAKE_REQUIRED_INCLUDES "${CMAKE_SOURCE_DIR}/include/modules/submodule.h")
    check_symbol_exists(SUBMODULE_VAR "${CMAKE_SOURCE_DIR}/include/modules/submodule.h" VAR_DEFINED)
    if(VAR_DEFINED)
        message("Hello world!")
    endif()
    cmake_pop_check_state()
